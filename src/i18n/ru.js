export default {
    ...
    "footer": {
        ...
        "company": {
            "name": "ООО «ОРИНА ТЕХН»",
            "address": "ул. Университетская, дом 5, помещение 115, раб.место 40/4, Иннополис, Россия",
        },
        "social": {
            "twitter": "Твиттер",
            "linkedin": "Линкедин",
    ...
    "blog": {
        "title": "Инсайды индустрии красоты",
        "subtitle": "Оставайтесь в курсе последних трендов, советов и новостей из индустрии красоты.",
        "readMore": "Читать далее",
        "categories": {
            "all": "Все посты",
            "trends": "Тренды красоты",
            "tips": "Советы по красоте",
            "business": "Бизнес салона"
        },
        "featured": {
            "title": "Выделенные посты",
            "subtitle": "Наши самые популярные статьи"
        },
        "latest": {
            "title": "Последние посты",
            "subtitle": "Свежий контент для любителей красоты"
        }
    }
}